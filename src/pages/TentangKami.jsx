...
import { about, fungsiList, membership, pengurus, pengawas } from '../data/siteData';
          ...
          <div className="reveal-item relative">
            <div className="rounded-2xl overflow-hidden aspect-[4/3] shadow-card">
              <img
                ...
                alt="Dokter Hewan" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700"
              />
            </div>
            {/* Vision pill */}
            <div className="absolute top-[-16px] right-[-16px] bg-kvi-600 rounded-xl p-4 shadow-card max-w-[180px]">
              <div className="text-[10px] font-bold text-white/70 tracking-widest uppercase mb-1">Visi</div>
              <div className="text-xs font-semibold text-white leading-snug">Profesi Veteriner Unggul &amp; Berintegritas</div>
            </div>
          </div>

          <div className="reveal-item">
            <span className="text-[10px] font-body uppercase tracking-widest text-kvi-500 font-bold">{about.label}</span>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 mb-2 leading-tight">{about.title}</h2>
            <div className="h-1 w-16 bg-kvi-500 rounded mb-5" />
            <p className="text-zinc-600 font-body leading-relaxed mb-5 text-sm md:text-base">{about.intro}</p>
            ...
            <div className="flex flex-wrap gap-2">
              {ASOSIASI.map((a) => (
                <span key={a} className="px-3 py-1.5 rounded-md bg-kvi-50 text-kvi-700 text-xs font-semibold border border-kvi-100">{a}</span>
              ))}
            </div>
          </div>
        </div>
    ...
    <section id="section-fungsi" className="relative py-20 bg-paper-100">
      <div className="max-w-[1320px] mx-auto px-6 md:px-8">
        <div className="text-center mb-12 md:mb-14">
          <span className="text-[10px] uppercase tracking-widest text-kvi-500 font-bold font-body reveal-item">Fungsi Organisasi</span>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 reveal-item">Peran Strategis KVI</h2>
    ...
    <section id="section-keanggotaan" className="bg-white py-20">
      <div className="max-w-[1320px] mx-auto px-6 md:px-8">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative bg-navy-800 rounded-2xl p-12 overflow-hidden shadow-card reveal-item">
            ...
            <div className="relative">
              <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-kvi-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <h3 className="font-display text-2xl font-bold text-white mb-3">Informasi Keanggotaan KVI</h3>
              <p className="text-white/65 text-sm leading-relaxed mb-6">Setiap anggota memiliki hak dan kewajiban yang ditetapkan dalam AD/ART perkumpulan.</p>
              <button
          ...
          <div className="reveal-item">
            <span className="text-[10px] font-body uppercase tracking-widest text-kvi-500 font-bold">{membership.label}</span>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 mb-2 leading-tight">Hak &amp; Kewajiban Anggota</h2>
    ...
    <section id="section-org" className="bg-paper-100 py-20">
      <div className="max-w-[1320px] mx-auto px-6 md:px-8">
        <div className="text-center mb-12">
          <span className="text-[10px] uppercase tracking-widest text-kvi-500 font-bold font-body reveal-item">Struktur Organisasi</span>
          <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 reveal-item">Pengurus &amp; Pengawas KVI</h2>
          <div className="h-1 w-16 bg-kvi-500 rounded mt-4 mx-auto reveal-item" />
          {/* Tab toggle */}
...
export default function TentangKami() {
  ...
  return (
    <>
      <PageHero
        breadcrumbs={[{ label: 'Beranda', path: '/' }, { label: 'Tentang Kami' }]}
        title={'KONSIL\nVETERINER\nINDONESIA'}
