...
export default function EtikaStandar() {
  return <UnderConstruction title="Etika & Standar" />;
}
...
const PRINSIP = [
  {
    no: "01",
    judul: "Kesejahteraan Hewan",
    warna: "text-kvi-600",
    bg: "bg-kvi-50",
    border: "border-kvi-200",
    icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z",
    desc: "Dokter hewan wajib mengutamakan kesejahteraan dan perlindungan hewan dalam setiap tindakan medis yang dilakukan.",
  },
  {
    no: "02",
    judul: "Kompetensi Profesional",
    warna: "text-navy-700",
    bg: "bg-navy-50",
    border: "border-navy-200",
    icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z",
    desc: "Setiap praktisi hanya boleh melakukan tindakan medis sesuai kompetensi yang dimiliki dan terus meningkatkan keahlian.",
  },
  {
    no: "03",
    judul: "Integritas & Kejujuran",
    warna: "text-amber-700",
    bg: "bg-amber-50",
    border: "border-amber-200",
    icon: "M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3",
    desc: "Dokter hewan wajib bertindak dengan kejujuran, transparansi, dan tidak melakukan manipulasi data atau informasi medis.",
  },
  {
    no: "04",
    judul: "Kerahasiaan Klien",
    warna: "text-violet-700",
    bg: "bg-violet-50",
    border: "border-violet-200",
    icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
    desc: "Informasi klien dan catatan medis hewan bersifat rahasia dan tidak boleh disebarluaskan tanpa izin yang sah.",
  },
  {
    no: "05",
    judul: "Hubungan Profesional",
    warna: "text-sky-700",
    bg: "bg-sky-50",
    border: "border-sky-200",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
    desc: "Hubungan antar kolega harus dilandasi saling menghormati, kolaborasi positif, dan tidak merendahkan profesi sesama.",
  },
  {
    no: "06",
    judul: "Tanggung Jawab Publik",
    warna: "text-rose-700",
    bg: "bg-rose-50",
    border: "border-rose-200",
    icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
    desc: "Dokter hewan bertanggung jawab pada kesehatan masyarakat, keamanan pangan, dan kesehatan lingkungan dalam praktiknya.",
  },
];

const KOMPETENSI = [
  {
    area: "Klinis & Diagnosis",
    level: "Wajib",
    poin: [
      "Pemeriksaan fisik sistematis",
      "Interpretasi hasil laboratorium",
      "Penegakan diagnosis banding",
      "Tindakan bedah dasar",
    ],
  },
  {
    area: "Farmakologi Veteriner",
    level: "Wajib",
    poin: [
  ...
  {
    area: "Manajemen Praktik",
    level: "Anjuran",
    poin: [
      "Etika dan hukum veteriner",
      "Komunikasi klien",
...
const SANKSI = [
  {
    ...
    bg: "bg-amber-50",
    border: "border-amber-200",
    desc: "Teguran lisan atau tertulis, kewajiban mengikuti pelatihan etika.",
  },
  {
    level: "Sedang",
    warna: "text-orange-700",
    bg: "bg-orange-50",
    border: "border-orange-200",
    desc: "Pembatasan sementara praktik, kewajiban pendampingan supervisor.",
  },
  {
    level: "Berat",
    warna: "text-rose-700",
    bg: "bg-rose-50",
    border: "border-rose-200",
    desc: "Pencabutan STRV/SIP sementara hingga permanen.",
  },
];
...
function PengaduanForm() {
    ...
    return (
      <div className="bg-kvi-50 border-2 border-kvi-200 rounded-2xl p-12 text-center">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-sm mx-auto mb-6">
          Tim KVI akan memverifikasi laporan Anda dalam 3 hari kerja.
        </p>
        <button
          onClick={() => setSent(false)}
          className="px-6 py-2.5 bg-kvi-500 hover:bg-kvi-600 text-white rounded-lg text-sm font-bold transition-colors"
        >
  ...
  return (
    <div className="bg-paper-50 rounded-2xl border border-paper-200 p-8 shadow-soft">
      <h3 className="font-display font-bold text-navy-800 text-xl mb-6">
        Formulir Pengaduan
      </h3>
          ...
          <div className="max-w-[1320px] mx-auto px-6 md:px-8">
            ...
            <div className="grid md:grid-cols-[1fr_1fr_1fr_340px] gap-5">
              ...
              <div className="bg-navy-800 rounded-2xl p-7 text-white sticky top-24 h-fit">
                <div className="text-[10px] font-bold text-white/50 uppercase tracking-widest mb-5">
                  Detail Prinsip
                </div>
        ...
        <section id="kompetensi" className="bg-white py-20">
          <div className="max-w-[1320px] mx-auto px-6 md:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 mb-2">
                Area Kompetensi Dokter Hewan
              </h2>
              <div className="h-1 w-16 bg-kvi-500 rounded mx-auto" />
            </div>
            <div className="grid sm:grid-cols-2 gap-5">
              {KOMPETENSI.map((sk, i) => (
                <div key={i} className="bg-paper-50 rounded-2xl p-7 border border-paper-200">
        ...
        <section id="disiplin" className="bg-paper-100 py-20">
          <div className="max-w-[1320px] mx-auto px-6 md:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {SANKSI.map((s, i) => (
                <div key={i} className={`bg-white rounded-2xl p-7 border-2 ${s.border}`}>
                  <span className={`inline-block text-[11px] font-bold px-3 py-1 rounded-lg border mb-4 ${s.bg} ${s.warna} ${s.border}`}>
                    Pelanggaran {s.level}
                  </span>
        ...
        <section id="pengaduan" className="bg-white py-20">
          <div className="max-w-[1320px] mx-auto px-6 md:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-bold text-navy-800 mt-3 mb-2">
                Ajukan Pengaduan Etik
              </h2>
              <div className="h-1 w-16 bg-kvi-500 rounded mx-auto mb-4" />
              <p className="text-zinc-500 text-sm max-w-md mx-auto">
                Setiap pengaduan akan ditangani secara profesional, rahasia, dan adil oleh Majelis Etik KVI.
              </p>
            </div>
