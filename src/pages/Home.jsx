          ...
          {heroSlides.map((slide, i) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(6,37,67,0.88), rgba(10,54,92,0.55), rgba(6,37,67,0.15))",
                }}
              />
              <div className="relative z-10 h-full max-w-[1320px] mx-auto px-6 md:px-8 flex flex-col justify-center">
                <div className="max-w-2xl">
                  <h1
                    className="font-display text-3xl md:text-5xl lg:text-[52px] font-extrabold text-white leading-[1.12] mb-5 uppercase tracking-tight"
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    <div className="flex items-center gap-2 text-[10px] uppercase tracking-widest mb-2">
                      <span
                        className={`font-semibold px-2 py-0.5 rounded ${KAT_COLOR[item.kategori] || "bg-zinc-100 text-zinc-600"}`}
                      >
                        {item.kategori}
                      </span>
                      <span className="text-zinc-400">{item.tanggal}</span>
                    </div>
                    <h3 className="font-display font-bold text-navy-800 text-[15px] leading-snug mb-3 line-clamp-2 flex-1">
                      {item.judul}
                    </h3>
                    <Link
                      to={`/berita/${item.slug}`}
        ...
        <div className="grid md:grid-cols-[380px_1fr] gap-16 items-start">
          ...
          <div className="md:sticky md:top-24">
            ...
            <p className="text-zinc-500 font-body text-sm leading-relaxed mb-8">
              Temukan jawaban atas pertanyaan umum seputar registrasi, lisensi,
              etika profesi, dan layanan KVI.
            </p>
            <Link
              to="/kontak"
          ...
          <div className="flex flex-col gap-3">
            {homeFaq.map((f, i) => (
              ...
              >
                ...
                >
                  <span className="font-display font-bold text-navy-800 text-[15px] leading-snug">
                    {f.q}
                  </span>
                  <span
