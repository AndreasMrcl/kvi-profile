...
export default function UnderConstruction({ title = "Halaman" }) {
  return (
    <section className="relative bg-navy-800 text-white overflow-hidden">
      ...
      <div className="relative max-w-[900px] mx-auto px-6 md:px-8 py-20 md:py-28 text-center">
        <div className="text-kvi-300 font-display text-[54px] md:text-[72px] font-extrabold tracking-tight">
          {title}
        </div>
        <h1 className="font-display text-2xl md:text-4xl font-bold mt-4 mb-4">
          Sedang dalam pengerjaan
        </h1>
        <p className="text-white/70 text-sm md:text-base leading-relaxed mb-8">
          Kami sedang menyiapkan konten terbaik untuk halaman ini. Silakan cek
