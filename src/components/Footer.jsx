      ...
      <div className="max-w-[1320px] mx-auto px-6 md:px-8 py-14">
        <div className="grid md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-3">
            <h4 className="font-display font-bold text-white text-xs mb-4 tracking-widest uppercase">
              Quick Links
            </h4>
          ...
          <div className="md:col-span-3 flex flex-col items-center text-center">
            ...
            <p className="text-white/55 text-xs leading-relaxed mt-4 max-w-[220px]">
              Indonesian Veterinary Statutory Body — menjaga mutu profesi
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3 text-white/65 text-sm font-body">
              <li className="flex items-start gap-2.5">
                <svg
                  className="w-4 h-4 mt-0.5 flex-shrink-0 text-kvi-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.8}
              ...
              <li className="flex items-center gap-2.5">
                <svg
                  className="w-4 h-4 flex-shrink-0 text-kvi-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.8}
                ...
                <a
                  ...
                  className="hover:text-kvi-300 transition-colors"
                >
                  {contact.email}
                </a>
              </li>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-center text-white/45 text-xs font-body">
          © {new Date().getFullYear()} KONSIL VETERINER INDONESIA. Seluruh hak
          cipta dilindungi.
        </div>
      </div>
    </footer>
